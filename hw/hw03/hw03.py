...
def interleaved_sum(n, odd_term, even_term):
    ...
    def func(x, is_odd):
        ...
        return func(x + 1, not is_odd) + (lambda a : odd_term(a) if is_odd else even_term(a))(x)
...
def count_coins(total):
    ...
    def func(sum, minm):
        ...
        if(sum < 0 or minm == None):
            return 0
        
        if(sum == 0):
            return 1

        return func(sum - minm, minm) + func(sum, next_larger_coin(minm))
